                ...
                <div class="row g-0">
                    <div class="col col-xl-12 text-center">
                        <div class="card-body p-4 text-center">
                            <h1 class="display-1" style="font-size: 150px"><span class="text-primary">4</span><span class="text-danger">0</span><span class="text-success">1</span></h1>
                            <h2 class="font-weight-bold display-4">Unauthenticated</h2>
