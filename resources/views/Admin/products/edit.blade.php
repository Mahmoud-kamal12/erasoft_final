        ...
        <div class="card-body">
            <form action="{{route('admin.products.update' , $product->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 text-secondary">
                        <input type="number" name="quantity" step="1" min="0" class="form-control" value="{{$product->quantity}}" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 text-secondary">
                        <input type="text" name="short_description" step="1" min="0" class="form-control" value="{{$product->short_description}}" />
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 text-center text-secondary">
                        ...
                        <div id="faqs_body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 text-secondary">
                                    <input type="text" name="specifications[{{$index}}][key]" class="form-control" value="{{$specification['key']}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10 text-secondary">
                                    <input type="text" name="specifications[{{$index}}][value]" class="form-control" value="{{$specification['value']}}" />
                                </div>
                            </div>
                        </div>
                    </div>
